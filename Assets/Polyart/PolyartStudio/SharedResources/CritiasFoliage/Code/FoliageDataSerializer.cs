    ...
    public class FoliageDataSerializer
    {
        ...
        public static FoliageData LoadFromFileEditTime(string filename)
        {
            ...
            if (!Directory.Exists(Application.streamingAssetsPath))
            {
                ...
                var initialPath = Path.Combine(Application.dataPath + "/Polyart/PolyartStudio/SharedResources/CritiasFoliage/StreamingAssets/");
                var finalPath = Path.Combine(Application.dataPath + "/StreamingAssets/");
        ...
        public static void SaveToFile(string filename, FoliageData data)
        {
            ...
            var folder = Directory.CreateDirectory(Application.streamingAssetsPath);
            string path = Path.Combine(Application.streamingAssetsPath, filename);
